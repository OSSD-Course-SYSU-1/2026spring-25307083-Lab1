...
class DateCalcPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(39:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 模式切换
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(43:7)", "entry");
            // 模式切换
            Row.width('100%');
            // 模式切换
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(44:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(54:9)", "entry");
            Button.fontSize({ "id": 16777262, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
    ...
    buildHeader(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(85:5)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(86:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('←');
            Text.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(87:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('日期计算');
            Text.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(93:7)", "entry");
            Text.fontSize({ "id": 16777265, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
    ...
    buildIntervalMode(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(106:5)", "entry");
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(110:7)", "entry");
            Row.width('100%');
            Row.justifyContent(FlexAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('↓');
            Text.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(111:9)", "entry");
            Text.fontSize(24);
    ...
    buildAddSubMode(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(125:5)", "entry");
            Column.width('100%');
            Column.padding({ left: 16, right: 16, top: 4 });
        }, Column);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 天数输入
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(130:7)", "entry");
            // 天数输入
            Column.width('100%');
            // 天数输入
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(131:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(134:9)", "entry");
            Row.width('100%');
            Row.margin({ top: 8 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('-');
            Button.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(135:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(144:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('+');
            Button.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(152:11)", "entry");
            Button.fontSize({ "id": 16777265, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 快捷天数
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(164:9)", "entry");
            // 快捷天数
            Row.width('100%');
            // 快捷天数
            Row.margin({ top: 6 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Button.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(166:13)", "entry");
    ...
    buildDateCard(title: string, year: number, month: number, day: number, onChange: (y: number, m: number, d: number) => void, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(190:5)", "entry");
            Column.width('100%');
            Column.padding(16);
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(title);
            Text.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(191:7)", "entry");
            Text.fontSize({ "id": 16777264, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
            Text.fontColor('#999999');
            Text.width('100%');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(195:7)", "entry");
            Row.width('100%');
            Row.margin({ top: 4, bottom: 8 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.formatDate(year, month, day));
            Text.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(196:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(200:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            DatePicker.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(206:7)", "entry");
    ...
    buildResultPanel(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(224:5)", "entry");
            Column.width('100%');
            Column.padding(20);
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
            ...
            if (this.currentMode === CalcMode.INTERVAL) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(226:9)", "entry");
                        ...
                        if (this.intervalResult) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(233:11)", "entry");
                                    Text.fontSize({ "id": 16777262, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
                                    Text.fontColor('#999999');
                                    Text.margin({ top: 4 });
                                    Text.textAlign(TextAlign.Center);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(240:9)", "entry");
                        Text.fontSize({ "id": 16777240, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
                        Text.fontWeight(FontWeight.Bold);
                        Text.fontColor('#007DFF');
                        Text.textAlign(TextAlign.Center);
                        ...
                        if (this.addSubResult) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("entry/src/main/ets/pages/DateCalcPage.ets(247:11)", "entry");
                                    Text.fontSize({ "id": 16777262, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
                                    Text.fontColor('#999999');
                                    Text.margin({ top: 4 });
                                    Text.textAlign(TextAlign.Center);
