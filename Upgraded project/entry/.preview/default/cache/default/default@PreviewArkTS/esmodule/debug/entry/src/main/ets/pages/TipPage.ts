...
class TipPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/TipPage.ets(25:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/pages/TipPage.ets(28:7)", "entry");
            Scroll.layoutWeight(1);
            Scroll.width('100%');
        }, Scroll);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/TipPage.ets(29:9)", "entry");
            Column.width('100%');
        }, Column);
        // 账单金额
    ...
    buildHeader(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/TipPage.ets(59:5)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/TipPage.ets(60:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('←');
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(61:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('小费计算');
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(67:7)", "entry");
            Text.fontSize({ "id": 16777265, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
    ...
    buildBillInput(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/TipPage.ets(78:5)", "entry");
            Column.width('100%');
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('账单金额');
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(79:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/TipPage.ets(83:7)", "entry");
            Row.width('100%');
            Row.margin({ top: 8 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('¥');
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(84:9)", "entry");
            Text.fontSize({ "id": 16777240, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor('#1A1A1A');
            Text.margin({ right: 4 });
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/pages/TipPage.ets(88:9)", "entry");
    ...
    buildTipSelector(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/TipPage.ets(104:5)", "entry");
            Column.width('100%');
            Column.padding(16);
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('小费比例');
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(105:7)", "entry");
            Text.fontSize({ "id": 16777264, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
            Text.fontColor('#999999');
            Text.width('100%');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 预设比例按钮
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/TipPage.ets(110:7)", "entry");
            // 预设比例按钮
            Row.width('100%');
            // 预设比例按钮
            Row.margin({ top: 8 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Button.debugLine("entry/src/main/ets/pages/TipPage.ets(112:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/TipPage.ets(127:9)", "entry");
            Button.fontSize({ "id": 16777264, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
    ...
    buildCustomPercent(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/TipPage.ets(145:5)", "entry");
            Column.width('100%');
            Column.padding(16);
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('自定义比例 (%)');
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(146:7)", "entry");
            Text.fontSize({ "id": 16777264, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
            Text.fontColor('#999999');
            Text.width('100%');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/pages/TipPage.ets(150:7)", "entry");
            TextInput.fontSize({ "id": 16777261, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
            TextInput.type(InputType.Number);
    ...
    buildPeopleSelector(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/TipPage.ets(164:5)", "entry");
            Column.width('100%');
            Column.padding(16);
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('分摊人数');
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(165:7)", "entry");
            Text.fontSize({ "id": 16777264, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
            Text.fontColor('#999999');
            Text.width('100%');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/TipPage.ets(169:7)", "entry");
            Row.width('100%');
            Row.margin({ top: 8 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithChild({ type: ButtonType.Circle });
            Button.debugLine("entry/src/main/ets/pages/TipPage.ets(170:9)", "entry");
            Button.width(40);
            Button.height(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('-');
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(171:11)", "entry");
            Text.fontSize({ "id": 16777265, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(178:9)", "entry");
            Text.fontSize({ "id": 16777240, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor('#1A1A1A');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithChild({ type: ButtonType.Circle });
            Button.debugLine("entry/src/main/ets/pages/TipPage.ets(182:9)", "entry");
            Button.width(40);
            Button.height(40);
            Button.backgroundColor('#F0F7FF');
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('+');
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(183:11)", "entry");
            Text.fontSize({ "id": 16777265, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
            Text.fontColor('#007DFF');
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/TipPage.ets(190:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
            if (this.peopleCount > 1) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('👥 多人分摊');
                        Text.debugLine("entry/src/main/ets/pages/TipPage.ets(193:11)", "entry");
    ...
    buildResultPanel(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/TipPage.ets(206:5)", "entry");
            Column.width('100%');
            Column.padding(20);
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 小费金额
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/TipPage.ets(208:7)", "entry");
            // 小费金额
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('💵 小费金额');
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(209:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/TipPage.ets(211:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`¥ ${this.tipAmount}`);
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(212:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Divider.create();
            Divider.debugLine("entry/src/main/ets/pages/TipPage.ets(218:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 总金额
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/TipPage.ets(221:7)", "entry");
            // 总金额
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('💰 应付总额');
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(222:9)", "entry");
            Text.fontSize({ "id": 16777261, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
            Text.fontColor('#666666');
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/TipPage.ets(224:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`¥ ${this.totalAmount}`);
            Text.debugLine("entry/src/main/ets/pages/TipPage.ets(225:9)", "entry");
            Text.fontSize({ "id": 16777271, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor('#1A1A1A');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.peopleCount > 1) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Divider.create();
                        Divider.debugLine("entry/src/main/ets/pages/TipPage.ets(232:9)", "entry");
                        Divider.margin({ top: 12, bottom: 12 });
                        Divider.color('#F0F0F0');
                    }, Divider);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/pages/TipPage.ets(234:9)", "entry");
                        Row.width('100%');
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('👤 每人应付');
                        Text.debugLine("entry/src/main/ets/pages/TipPage.ets(235:11)", "entry");
                        Text.fontSize({ "id": 16777261, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
                        Text.fontColor('#666666');
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Blank.create();
                        Blank.debugLine("entry/src/main/ets/pages/TipPage.ets(237:11)", "entry");
                    }, Blank);
                    Blank.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create(`¥ ${this.perPerson}`);
                        Text.debugLine("entry/src/main/ets/pages/TipPage.ets(238:11)", "entry");
                        Text.fontSize({ "id": 16777271, "type": 10002, params: [], "bundleName": "com.example.simplecalculator", "moduleName": "entry" });
                        Text.fontWeight(FontWeight.Bold);
                        Text.fontColor('#007DFF');
                    }, Text);
